...
if (isset($_GET['delete'])) 
{
    ...
    $create = mysqli_query($ketnoi,"DELETE FROM `ls_logo` WHERE `id` = '".$delete."' ");
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Lịch Sử Tạo Logo</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                                ...
                                <table id="datatable1" class="table table-bordered table-striped">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Logo</th>
                                            <th>USERNAME</th>
                                            <th>Link Logo Khi Hoàn Thành</th>
                                            <th>STATUS</th>
                                            <th>THAO TÁC</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php
                                                $result = mysqli_query($ketnoi,"SELECT * FROM `ls_logo`");
