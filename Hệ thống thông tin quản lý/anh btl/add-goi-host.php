...
<a href="https://there24h.com/admin/news/images">
   ...
   Danh sách ảnh
    ...
    <div class="cpanel-wrap">
                <div class="form-m1">
            <form method="POST" action="/admin/add-goi-host.php" accept-charset="UTF-8" enctype="multipart/form-data">
             <div class="row row5">
