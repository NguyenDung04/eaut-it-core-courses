...
{
  $create = mysqli_query($ketnoi,"INSERT INTO `ds_bank` SET 
    `name` = '".$_POST['name']."',
                                    ...
                                    <form role="form" action="" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="textarea" name="noidung" placeholder="Place some text here"
                                                style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?=$toz_bank['noidung'];?></textarea>
                                        </div>
