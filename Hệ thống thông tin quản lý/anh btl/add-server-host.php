...
<a href="https://there24h.com/admin/news/images">
   ...
   Danh sách ảnh
    ...
    <div class="cpanel-wrap">
                <div class="form-m1">
            <form method="POST" action="/admin/add-server-host.php" accept-charset="UTF-8" enctype="multipart/form-data">
             <div class="row row5">
                        ...
                        <div class="col-lg-6">
                            <div class="position-relative mt-1">
                                ...
                                <input name="tk_whm" type="text" class="form-control" id="tk_whm"
                                       placeholder="TÀI KHOẢN WHM" value="">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="position-relative mt-1">
                                <label for="" class="col-form-label font-weight-bold">MẬT KHẨU WHM:</label>
                                <input name="mk_whm" type="text" class="form-control" id="mk_whm"
                                       placeholder="MẬT KHẨU WHM" value="">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="position-relative mt-1">
